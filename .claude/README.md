...
| Voy a cerrar una sesión 🔒 o un diff que toca API/contratos | `/mutacion` + `/juicio` (en ese orden, y siempre antes de worklog/puntero) |
...
flowchart TD
    subgraph W1 [W1 · Feature nueva]
        ...
        M --> J[/juicio/]
        T -->|si no 🔒| J
        J --> D[DoD + puntero ▶ + worklog, mismo commit]
    end
...
4. El juicio va **antes** de escribir worklog/puntero.
