...
## G44 · El scheduler no se bombea fuera de los `Eval`: el modo interactivo no ejecuta tasks y los timers de fondo mueren en cada quiescencia — `api.md` §3 / `modelo-ejecucion.md` — **ABIERTO**
