...
| ADR-030 | Política estable de contribuciones: DCO; el contribuidor conserva su copyright y se retira la cesión/CLA caso por caso | Aceptada | [adr-030-politica-de-contribuciones-dco.md](adr-030-politica-de-contribuciones-dco.md) |
| ADR-031 | El binario vive en `cmd/enu/`; la raíz del repo queda sin código Go (refina la ubicación de ADR-026) | Aceptada | [adr-031-el-binario-vive-en-cmd-enu.md](adr-031-el-binario-vive-en-cmd-enu.md) |
| ADR-032 | `plan/` y `postponed/` adoptan un fichero por entrada; `estado.md` se reduce a puntero + tablero (el registro por sesión vive en `worklog/`) | Aceptada | [adr-032-plan-y-postponed-un-fichero-por-entrada.md](adr-032-plan-y-postponed-un-fichero-por-entrada.md) |
