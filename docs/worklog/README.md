...
| S54 | Elección por teclado en la pantalla de runtime desnudo (Fase 10; G21/ADR-010, 🔒): máquina de estados en Go + flag+poll (anti-deadlock); fixes de juicio C1/C2 (parar el pump al rebootear) y H1 (red de salida tras activar, ADR-017) | [s54-teclado-pantalla-desnuda.md](s54-teclado-pantalla-desnuda.md) |
